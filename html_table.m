...
if p.Results.WriteFileHtmlHeaders
    appendText = '';
    if contains(fname,'allEpidemicData_Report','IgnoreCase',true)
        appendText = '</table> <img src="images/Coronavirus_pandemic.png" alt="Coronavirus_pandemic" width="200" height="200">';
    end
    fprintf(fid,strcat(' \t',appendText,'</body>\n\n</html>'));
end
