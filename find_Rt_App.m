function find_Rt_App(population, filename, regionName)
...
f_suscep = 0.75;   % <--- fraction of the total susceptible population that is exposed to infection                  
...
saveas(figure(100),strrep(filename, 'txt','png'));
% =======================================================
%
...
fileID = fopen(strrep(filename, '.txt','_Rt_Results.txt'),'w');
fprintf(fileID,' |===========|==========| \n')
format_1 = ' | day/month |    R_t   | \n';
fprintf(fileID,format_1)
fprintf(fileID,' |-----------|----------| \n')
...
for j = j0+3:jF-3
    ...
    fprintf(fileID,format_2,day,name_month,Rt(j))
end
fprintf(fileID,' |===========|==========| \n')
fclose(fileID);
